...
namespace Json.Facts
{
    public class JsonStringFacts
    {
        ...
        [Fact]
        public void DoesNotContainAnUnfinishedHexNumber()
        {
            Assert.False(IsJsonString(Quoted(@"a\u123 5*")));
        }

        [Fact]
        public void DoesNotContainInvalidHexDigits()
        {
            Assert.False(IsJsonString(Quoted(@"a\u12qw")));
        }

        [Fact]
        public void DoesNotContainAnyInvalidHexDigits()
        {
            Assert.False(IsJsonString(Quoted(@"a\u1234 i\u12io")));
        }

        [Fact]
        public void DoesNotContainInvalidHexDigitsAtTheMiddle()
        {
